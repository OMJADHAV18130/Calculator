...
class CalcApp(QWidget):
    def __init__(self):
        ...
        self.text_box.setStyleSheet("QLineEdit {background-color : yellow; color : black; font-size : 24; margin : 10px; padding : 10px;font-style : bold}")
...
if __name__ == "__main__":
    app = QApplication([])
    main_window = CalcApp()
    main_window.setStyleSheet("QWidget {background-color: crimson}")
    main_window.show()
    app.exec_()
